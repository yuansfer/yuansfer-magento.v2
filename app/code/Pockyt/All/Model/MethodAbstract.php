...
use Pockyt\All\Included\Requestor;
...
class MethodAbstract implements \Magento\Payment\Model\MethodInterface
{
    ...
    const CODE_UNIONPAY = 'pockyt_unionpay';
    const CODE_ALIPAY = 'pockyt_alipay';
    const CODE_WECHATPAY = 'pockyt_wechatpay';
    const CODE_CREDITCARD = 'pockyt_creditcard';
    const CODE_PAYPAL = 'pockyt_paypal';
    const CODE_VENMO = 'pockyt_venmo';
    ...
    {
        $this->logger->debug("Pockyt Payments - " . $this->code . ' - ' . $msg);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('pockyt/securePay/redirect', array('_secure' => true));
    }
    ...
    public function getTitle()
    {
        ...
        //     return $this->scopeConfig->getValue('payment/pockyt/alipay_title', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_store);
        // }

        // if ($this->code == self::CODE_UNIONPAY) {
        //     return $this->scopeConfig->getValue('payment/pockyt/unionpay_title', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_store);
        // }

        // if ($this->code == self::CODE_WECHATPAY) {
        //     return $this->scopeConfig->getValue('payment/pockyt/wechatpay_title', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_store);
        // }
    ...
    //     if($this->code) {
    //         if ($this->code == self::CODE_ALIPAY) {
    //             // return $this->scopeConfig->getValue('payment/pockyt/alipay_active', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_store);
    //             return $this->scopeConfig->getValue('payment/pockyt/alipay_active', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    //         }

    //         if ($this->code == self::CODE_UNIONPAY) {
    //             return $this->scopeConfig->getValue('payment/pockyt/unionpay_active', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    //         }

    //         if ($this->code == self::CODE_WECHATPAY) {
    //             return $this->scopeConfig->getValue('payment/pockyt/wechatpay_active', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    //         }
    //     }
